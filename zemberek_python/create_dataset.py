...
for file in ['xaa.txt', 'xab.txt', 'xac.txt', 'xad.txt']:
    zemberek.open(path=f'../data/newscor/{file}').process(min_tok=1, max_tok=15).write(f'../data/newscor_processed/source_{file}', mode='x',
                                                                                       write_target=True,target_path=f'../data/newscor_processed/target_{file}')
